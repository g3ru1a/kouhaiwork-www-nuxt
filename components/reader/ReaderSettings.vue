<template>
    <div class="w-full md:px-4 lg:px-0 lg:mx-auto lg:w-4/5 2xl:w-2/3 3xl:w-1/2">
        <div class="form-group-inline">
            <div @click="$router.push('/series/'+manga_id)" class="cursor-pointer w-full p-4 bg-white text-theme border border-theme flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                </svg>
                <p>Series Page</p>
            </div>
            <div @click="showSettings = !showSettings" class="cursor-pointer w-full p-4 bg-theme text-white flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
